...
# GitKraft's `kube-prometheus` Helm Chart
...
<p align="center">
    <a href="https://gitkraft.com/router?gk_operation=fork&gk_name=kube-prometheus.btnmi-chart.v0&gk_template_owner=tpl-gitkraft&gk_template_name=tpl.kube-prometheus.btnmi-chart.v0&gk_description=Helm%20chart%20for%20kube-prometheus%2C%20managed%20with%20GitKraft%20tooling&gk_visibility=private&mtm_campaign=fork&mtm_kwd=kube-prometheus.btnmi-chart.v0">
...
This repository hosts the GitKraft's open-source **kube-prometheus** Helm chart, originally
